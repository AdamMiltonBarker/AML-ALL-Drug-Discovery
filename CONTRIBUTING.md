# Contributing To The Peter Moss Acute Myeloid/Lymphoblastic Leukemia Drug Discovery Research & Development
...
If you would like to contribute bug fixes or make the team aware of bugs you have identified in the project, please raise a **Bug report** issue in the [Issues section](https://github.com/AMLResearchProject/AML-ALL-Drug-Discovery/issues/new/choose) section. A template is provided that will allow you to provide your suggestions for your bug report / bug fix(es) which will be reviewed by the team who will communicate through your issue.
